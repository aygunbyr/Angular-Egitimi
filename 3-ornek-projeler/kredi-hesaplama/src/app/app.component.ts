...
type OdemePlani = {taksitTutari: number, kalanGeriOdeme: number}
...
export class AppComponent {
  ...
  hesapla() {
    ...
    const toplamGeriOdeme: number = taksitTutari * this.taksitSayisi
    ...
    for (let i=0; i<this.taksitSayisi; i++) {
      const data: OdemePlani = {
        taksitTutari: taksitTutari,
        kalanGeriOdeme: toplamGeriOdeme - ((i + 1) * taksitTutari)
      }
